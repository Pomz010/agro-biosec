    ...
    <nav class="header-nav">
        <ul>
            <span id="headerNavContainer">
                ...
                <li class="{{ $navActive === 'response-management' ? 'nav-active' : '' }} nav-links"><a href="{{ route('response-logs.index') }}">Entry Logs</a></li>
                @can('viewAdminUsers')
            ...
            <span>
                ...
                <li><a href="{{ route('change.password', $currentUser->id) }}">Reset Password</a></li>
